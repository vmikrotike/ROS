...
def patch_npk_package(package, key_dict):
    if package[NpkPartID.NAME_INFO].data.name == 'system':
        ...
        run_shell_command(f"sudo sed -i '1s#.*#  MMMM    MMMM       KKK                           TTTTTTTTTTT       KKK#' {logo}")
        run_shell_command(f"sudo sed -i '2s#.*#  MMM MMMM MMM  III  KKK  KKK  RRRRRR     OOOOOO       TTT      III  KKK  KKK#' {logo}")
        run_shell_command(f"sudo sed -i '3s#.*#  MMM  MM  MMM  III  KKKKK     RRR  RRR  OOO  OOO      TTT      III  KKKKK#' {logo}")
        run_shell_command(f"sudo sed -i '4s#.*#  MMM      MMM  III  KKK KKK   RRRRRR    OOO  OOO      TTT      III  KKK KKK#' {logo}")
